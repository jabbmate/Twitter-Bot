...
public class MarkovChainTest {
    ...
    @Test
    public void testAddBigramValidInputs() {
    ...
    @Test
    public void testAddBigramNullString() {
        MarkovChain mc = new MarkovChain();
    ...
    public void testTrainEmptySentence() {
        MarkovChain mc = new MarkovChain();
        mc.train(Collections.emptyIterator());
        assertEquals(0, mc.chain.size());

    }

    @Test
    public void resetNullStartWord() {
        MarkovChain mc = new MarkovChain();
        assertThrows(IllegalArgumentException.class, () -> {
            mc.reset(null);
    ...
    public void testWalkOneSentence() {
        ...
        String[] expectedWords = { "CIS", "120", "eats", "CIS", "160"};
        MarkovChain mc = new MarkovChain();

        String sentence1 = "CIS 120 eats CIS 160";
        mc.train(Arrays.stream(sentence1.split(" ")).iterator());
