...
public class TweetParserTest {
    ...
    public void parseAndCleanSentenceEmpty() {
        assertThrows(NullPointerException.class, () -> {
            TweetParser.parseAndCleanSentence(null);

        });
    }

    @Test
    public void testCsvDataToTweetsSimpleCSVSkipsNullLine() {
    ...
    @Test
    public void testParseAndCleanTweetRemoves2URLS() {
        List<List<String>> sentences = TweetParser
                .parseAndCleanTweet("http://cnet.com hello http://www.cis.upenn.edu");
    ...
    public void testCsvDataToTrainingDataEmptySentences() {
        ...
        List<List<String>> expected = new LinkedList<List<String>>();
        expected.add(listOfArray("hello".split(" ")));
    ...
    /* Here's an example test case. Be sure to add your own as well */
    @Test
    public void testParseAndCleanTweetRemovesOnlyURLS1() {
        List<List<String>> sentences = TweetParser
