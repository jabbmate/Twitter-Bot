...
public class MarkovChain implements Iterator<String> {
    ...
    void addBigram(String first, String second) {
        ...
        ProbabilityDistribution<String> pb = new ProbabilityDistribution<>();
    ...
    public boolean hasNext() {
        return !currentWord.equals(END_TOKEN);
    ...
    @Override
    public String next() {
        String current = this.currentWord;
        this.currentWord = chain.get(this.currentWord).pick(ng);
